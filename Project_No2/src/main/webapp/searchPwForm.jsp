...
<body style="padding-top: 57px;">
	...
	function validateForm(form) { //form 객체를 매개변수로 받아
		if(!form.user_id.value){ //form의 user_pw의 값이 없으면 if문실행
			alert("아이디를 입력하세요.");
			return false;
		}
...
<div class="container">
	<div class="card align-middle" style="width:20rem; border-radius:20px; ">
		...
		<div class="card-body">
      		<form class="form-signin" action="searchPwResult.jsp" method="post" name="loginFrm" onsubmit="return validateForm(this);">
        		...
        		<% request.getAttribute("LoginErrMsg");%>
        			...
        			<label for="phoneNum" class="sr-only">전화번호</label>
          			...
          			<a href="#" value="find_id">비밀번호찾기</a> -->
        				...
        				<div class="col">
        				<div class="mb-2">
        					<button type="submit" class="btn btn-outline-info btn-primary btn-sm ">비밀번호 찾기</button>
        				</div>
        				</div>
        				<div class="mb-2">
        				<div class="col">
